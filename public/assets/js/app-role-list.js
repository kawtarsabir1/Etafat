...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ajax: baseUrl + 'admin/gestion/roles', // JSON fie to add data
      columns: [
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Nouvel Rôle</span>',
          className: 'btn btn-primary btn-gradient mx-3',
          attr: {
            onclick: 'window.location.href="' + baseUrl + 'admin/role/create"'
          }
        }
      ],
