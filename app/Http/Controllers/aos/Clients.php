...
class Clients extends Controller
{
  ...
  {
    //get client where ID = $id 
    $objClient = Client::where('id', $id)->first();
    $objContact = Contact::where('client_id', $id)->get();
    
    return view('content\client\view-client', compact('objClient'),compact('objContact')); 
  }
