  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" id="btn-'+full['id']+'" class="text-body delete-record"><i class="ti ti-trash ti-sm mx-2"></i></a>' +
      ...
      initComplete: function () {
        // Adding Prenom filter once table initialized
        this.api()
          .columns(2)
          .every(function () {
            var column = this;
            var select = $(
              '<select id="UserPrenom" class="form-select text-capitalize"><option value=""> Select Prenom </option></select>'
            )
              .appendTo('.user_Prenom')
              .on('change', function () {
