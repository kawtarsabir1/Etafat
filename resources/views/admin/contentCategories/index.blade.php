    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.content-categories.create') }}">
                {{ trans('global.add') }} {{ trans('models.contentCategory.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('models.contentCategory.title_singular') }} {{ trans('global.list') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ContentCategory">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('models.contentCategory.fields.id') }}
                        </th>
                        <th>
                            {{ trans('models.contentCategory.fields.name') }}
                        </th>
                        <th>
                            {{ trans('models.contentCategory.fields.slug') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
