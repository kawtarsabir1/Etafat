...
@section('content')
    <x-PageHeader :header="\App\Http\Headers\TerrainHeader::show($terrain)"></x-PageHeader>

    <div class="row">
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Données générales</h4>
                    <x-Presentation.dataCard :items="[
                        'models.site.fields.code' => $terrain->site?->code,
                        'models.site.title_singular' => ['type'=>'preview', 'route'=>'admin.sites.show', 'id'=> $terrain->site?->id, 'data'=>$terrain->site?->denomination],

                        'models.terrain.fields.id' => $terrain->id,

                        'models.terrain.fields.id' => $terrain->id,
                        'models.terrain.fields.code' => $terrain->code,
                        'models.terrain.fields.nom' => $terrain->nom,
                        'models.terrain.fields.adresse' => $terrain->adresse,
                        'models.terrain.fields.type_detention' => $terrain->type_detention,
                        'models.terrain.fields.propretaire' => $terrain->propretaire,
                        'models.terrain.fields.type_terrain' => $terrain->type_terrain,
                        
                        'models.region_bam.title_singular' => $terrain->site?->region_bam?->nom,
                        'models.region_postale.title_singular' => $terrain->site?->region_postale?->nom,
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" role="tablist"> 
                        <li class="nav-item">
                            <a class="nav-link active" id="batiment-tab" data-bs-toggle="tab" href="#batiment"
                    ...
                    <div class="tab-content"> 
                        <div class="tab-pane active" id="batiment" aria-labelledby="batiment-tab" role="tabpanel">
                            <x-presentation.table :columns="['titre_foncier']" :items="$terrain->etages" route="admin.etages"></x-presentation.table>
                        </div>
                        <div class="tab-pane" id="etage" aria-labelledby="etage-tab" role="tabpanel">
                            <x-presentation.table :columns="['niveau']" :items="$terrain->etages" route="admin.etages"></x-presentation.table>
                        </div>
                        <div class="tab-pane" id="local" aria-labelledby="local-tab" role="tabpanel">
                            <x-presentation.table :columns="['type','niveau']" :items="$terrain->etages" route="admin.locals"></x-presentation.table>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabVerticalLeft-2-3" role="tabpanel" aria-labelledby="vertical-tab2-tab3">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($terrain->projets as $projet)
                                            <tr>
                                                <td>{{$projet->etat}}</td>
