    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.user-alerts.create') }}">
                {{ trans('global.add') }} {{ trans('models.userAlert.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('models.userAlert.title_singular') }} {{ trans('global.list') }}
    </div>
        ...
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-UserAlert">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('models.userAlert.fields.id') }}
                    </th>
                    <th>
                        {{ trans('models.userAlert.fields.alert_text') }}
                    </th>
                    <th>
                        {{ trans('models.userAlert.fields.alert_link') }}
                    </th>
                    <th>
                        {{ trans('models.userAlert.fields.user') }}
                    </th>
                    <th>
                        {{ trans('models.userAlert.fields.created_at') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
