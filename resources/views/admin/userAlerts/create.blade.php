...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('models.userAlert.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-alerts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="alert_text">{{ trans('models.userAlert.fields.alert_text') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('models.userAlert.fields.alert_text_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="alert_link">{{ trans('models.userAlert.fields.alert_link') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('models.userAlert.fields.alert_link_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="users">{{ trans('models.userAlert.fields.user') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('models.userAlert.fields.user_helper') }}</span>
            </div>
            <div class="form-group">
