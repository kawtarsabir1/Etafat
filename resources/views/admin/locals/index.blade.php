...
@section('content')
    ...
    <x-PageHeader :header="\App\Http\Headers\LocalHeader::index()"></x-PageHeader>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            @can('local_create')
                                <a class="btn btn-success float-start" href="{{ route('admin.locals.create') }}">
                                    {{ trans('global.add') }} {{ trans('models.local.title_singular') }}
                                </a>
                            @endcan
                        </div>
                        <div class="col-md-6">
                            ...
                            <x-datatable.search-modal
                                :service="new \App\Http\DataTables\LocalsDataTable()"
                                :dom="'search-modal'"
                                :url="url('admin/locals')"
                            ></x-datatable.search-modal>
                    ...
                    <div class="table-responsive">
                        <x-datatable.table
                            :tableDefinition="new \App\Http\DataTables\LocalsDataTable()"
