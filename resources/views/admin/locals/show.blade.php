...
@section('content')
    <x-PageHeader :header="\App\Http\Headers\LocalHeader::show($local)"></x-PageHeader>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tabVerticalLeft1" role="tabpanel"
                                                ...
                                                <x-Presentation.dataCard :items="[
                                                    'models.site.title_singular' => [
                                                        ...
                                                        'id' => $local->site?->id,
                                                        'data' => $local->site?->denomination,
                                                    ],
                                                    'models.etage.title_singular' => [
                                                        'type' => 'preview',
                                                        'route' => 'admin.etages.show',
                                                        'id' => $local->etage?->id,
                                                        'data' => $local->etage?->code,
                                                    ],
                                                    'models.local.fields.id' => $local->id,
                                                    'models.local.fields.code' => $local->code,
                                                    'models.local.fields.denomination' => $local->denomination,
                                                    'models.local.fields.adresse' => $local->adresse,
                                                    'models.local.fields.type_detention' => $local->type_detention,
                                                    'models.local.fields.proprietaire' => $local->proprietaire,
                                                    'models.local.fields.affectataire' => $local->affectataire,
                                                    'models.local.fields.bailleur' => $local->bailleur,
                                                    'models.region_bam.title_singular' => $local->site?->region_bam?->nom,
                                                    'models.region_postale.title_singular' => $local->site?->region_postale?->nom,
                                                ]"></x-Presentation.dataCard>
                                            </div>
                                            <div class="tab-pane" id="tabVerticalLeft2" role="tabpanel"
                                                aria-labelledby="vertical-tab-tab2">
                                                <x-Presentation.dataCard :items="[
                                                    'models.local.fields.type_activite' => $local->type_activite,
                                                    'models.local.fields.type' => $local->type,
                                                    'models.local.fields.nom_espace' => $local->nom_espace,
                                                    'models.local.fields.code_espace' => $local->code_espace,
                                                    'models.local.fields.superficie_espace' => $local->superficie_espace
                                                ]"></x-Presentation.dataCard>
                                            </div>
                                            <div class="tab-pane" id="tabVerticalLeft-2-3" role="tabpanel" aria-labelledby="vertical-tab2-tab3">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        @foreach($local->projets as $projet)
                                                            <tr>
                                                                <td>{{$projet->etat}}</td>
