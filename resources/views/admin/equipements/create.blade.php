...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('models.equipement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.equipements.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('famille') ? 'is-invalid' : '' }}" type="text" name="famille" id="famille" value="{{ old('famille', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sous_famille') ? 'is-invalid' : '' }}" type="text" name="sous_famille" id="sous_famille" value="{{ old('sous_famille', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('article') ? 'is-invalid' : '' }}" type="text" name="article" id="article" value="{{ old('article', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marque') ? 'is-invalid' : '' }}" type="text" name="marque" id="marque" value="{{ old('marque', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fournissuer') ? 'is-invalid' : '' }}" type="text" name="fournissuer" id="fournissuer" value="{{ old('fournissuer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valeur_acquisition') ? 'is-invalid' : '' }}" type="number" name="valeur_acquisition" id="valeur_acquisition" value="{{ old('valeur_acquisition', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_acquisition') ? 'is-invalid' : '' }}" type="text" name="date_acquisition" id="date_acquisition" value="{{ old('date_acquisition') }}">
