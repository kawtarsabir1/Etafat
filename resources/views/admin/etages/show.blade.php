...
@section('content')
    <x-PageHeader :header="\App\Http\Headers\EtageHeader::show($etage)"></x-PageHeader>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabVerticalLeft1" role="tabpanel"
                                ...
                                <x-Presentation.dataCard :items="[
                                    'models.etage.fields.id' => $etage->id,
                                    'models.etage.fields.code' => $etage->code,
                                    'models.etage.fields.adresse' => $etage->adresse,
                                    'models.etage.fields.type_detention' => $etage->type_detention,
                                    'models.etage.fields.proprietaire' => $etage->proprietaire,
                                    'models.etage.fields.bailleur' => $etage->bailleur,
                                    'models.etage.fields.type_construction' => $etage->type_construction,
                                    'models.etage.fields.statut_juridique' => $etage->statut_juridique, 
                                    'models.etage.fields.statut_propriete' => $etage->statut_propriete,
                                    'models.etage.fields.taxe' => $etage->taxe,
                                
                                    'models.site.title_singular' => [
                                        'type' => 'preview',
                                        'route' => 'admin.sites.show',
                                        'id' => $etage->site?->id,
                                        'data' => $etage->site?->denomination,
                                    ],
                                    'models.batiment.title_singular' => [
                                        'type' => 'preview',
                                        'route' => 'admin.batiments.show',
                                        'id' => $etage->batiment?->id,
                                        'data' => $etage->batiment?->denomination,
                                    ],
                                ]"></x-Presentation.dataCard>
                            </div>
                            <div class="tab-pane" id="tabVerticalLeft2" role="tabpanel" aria-labelledby="vertical-tab-tab2">
                                <x-Presentation.dataCard :items="[ 
                                    'models.etage.fields.superficie' => $etage->superficie,
                                    'models.etage.fields.sub' => $etage->sub,
                                    'models.etage.fields.sun' => $etage->sun,
                                    'models.etage.fields.shob' => $etage->shob,
                                    'models.etage.fields.shon' => $etage->shon,
                                    'models.etage.fields.hauteur' => $etage->hauteur,
                                ]"></x-Presentation.dataCard>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" role="tablist">   
                        <li class="nav-item">
                            <a class="nav-link active" id="local-tab" data-bs-toggle="tab" href="#local" aria-controls="local"
                                role="tab" aria-selected="false">Locaux</a>
                        </li>
                    </ul>
                    <div class="tab-content">  
                        <div class="tab-pane active" id="local" aria-labelledby="local-tab" role="tabpanel">
                            <x-presentation.table :columns="['type','niveau']" :items="$etage->locals" route="admin.locals"></x-presentation.table>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabVerticalLeft-2-3" role="tabpanel" aria-labelledby="vertical-tab2-tab3">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($etage->projets as $projet)
                                            <tr>
                                                <td>{{$projet->etat}}</td>
