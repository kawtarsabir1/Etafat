...
@section('content')
    ...
    <x-PageHeader :header="\App\Http\Headers\SiteHeader::index()"></x-PageHeader>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            @can('site_create')
                                <a class="btn btn-secondary btn-success float-start" href="{{ route('admin.sites.create') }}">
                                    <span><i class="ti ti-plus me-sm-1"></i> 
                                         <span class="d-none d-sm-inline-block">{{ trans('global.add') }} {{ trans('models.site.title_singular') }}</span>
                                    </span>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <x-datatable.search-modal
                                :service="new \App\Http\DataTables\SitesDataTable()"
                                dom="site-datatable"
                                :url="url('admin/sites')"
                            ></x-datatable.search-modal>
                    ...
                    <div class="table-responsive">
                        <x-datatable.table
                            :tableDefinition="new \App\Http\DataTables\SitesDataTable()"
                            dom="site-datatable"
                            :url="url('admin/sites')"
