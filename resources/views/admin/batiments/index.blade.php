...
@section('content')
    ...
    <x-PageHeader :header="\App\Http\Headers\BatimentHeader::index()"></x-PageHeader>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            @can('batiment_create')
                                <a class="btn btn-success float-start" href="{{ route('admin.batiments.create') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <x-datatable.search-modal
                                :service="new \App\Http\DataTables\BatimentsDataTable()"
                                :dom="'search-modal'"
                                :url="url('admin/batiments')"
                            ></x-datatable.search-modal>
                    ...
                    <div class="table-responsive">
                        <x-datatable.table
                            :tableDefinition="new \App\Http\DataTables\BatimentsDataTable()"
