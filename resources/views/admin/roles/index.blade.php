...
@section('content')
    ...
    <x-PageHeader :header="\App\Http\Headers\RoleHeader::index()"></x-PageHeader>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            @can('role_create')
                                <a class="btn btn-success float-start" href="{{ route('admin.roles.create') }}">
                                    {{ trans('global.add') }} {{ trans('models.role.title_singular') }}
                                </a>
                            @endcan
                        </div>
                        <div class="col-md-6">
                            ...
                            {{-- <x-datatable.search-modal
                                :service="new \App\Http\DataTables\rolesDataTable()"
                                :dom="'search-modal'"
                                :url="url('admin/roles')"
                            ></x-datatable.search-modal> --}}
                    ...
                    <div class="table-responsive">
                        <x-datatable.table
                            :tableDefinition="new \App\Http\DataTables\RolesDataTable()"
                            :dom="'role-datatable'"
                            :url="url('admin/roles')"
