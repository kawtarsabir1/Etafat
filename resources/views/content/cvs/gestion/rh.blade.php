...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                if ($.isEmptyObject(data.error)) {
                    alert('Responsable hiérarchique ajouté avec succés.');
                    location.reload();
                } else {
    ...
    function deleteRh(id) {
        if (confirm("Voulez-vous vraiment supprimer ce responsable hiérarchique ?")) {
            $.ajax({
                url: "/cv/deleteRh/" + id,
                type: 'DELETE',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
                        alert('Responsable hiérarchique supprimé avec succés.');
                        location.reload();
                    } else {
                        printErrorMsg(data.error);
                    }
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">CVtéque /</span> Gestion Des Responsables hiérarchiques
</h4>
                    ...
                    <div>
                        <ul class="list-group mb-4">
                            ...
                            <li class="list-group-item">
                                ...
                                <button type="button" onclick="editRh({{$rh->id}})" class="btn btn-primary mx-3 btn-sm float-end">Editer</button>
                            </li>
