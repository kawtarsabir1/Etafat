...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.btn-update').click(function (e) {
            ...
            $.ajax({
                url: baseUrl + 'cv/updateCategory/' + id,
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
                        alert('Category modifié avec succés.');
                        location.reload();
                    } else {
                        printErrorMsg(data.error);
                    }
                    ...
                    <div>
                        <ul class="list-group mb-4">
                            ...
                            <li class="list-group-item">
                                ...
                                <button type="button" onclick="editCategory({{$category->id}})" class="btn btn-primary btn-sm float-end me-2">Modifier</button>
                            </li>
                            @endforeach
                        </ul>
                    </div>
