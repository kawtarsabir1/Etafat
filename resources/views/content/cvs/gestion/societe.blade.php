...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                if ($.isEmptyObject(data.error)) {
                    alert('Societe ajouté avec succés.');
                    location.reload();
                } else {
    ...
    function deleteSociete(id) {
        if (confirm("Voulez-vous vraiment supprimer ce Societe ?")) {
            $.ajax({
                url: "/cv/deleteSociete/" + id,
                type: 'DELETE',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
                        alert('Societe supprimé avec succés.');
                        location.reload();
                    } else {
                        printErrorMsg(data.error);
                    }
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">CVtéque /</span> Gestion Des Societes
</h4>
