...
<script type="text/javascript">
    ...
    function deleteBu(id) {
        if (confirm("Voulez-vous vraiment supprimer ce BU ?")) {
            $.ajax({
                url: "/cv/deleteBu/" + id,
                type: 'DELETE',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
                        alert('BU supprimé avec succés.');
                        location.reload();
                    } else {
                        printErrorMsg(data.error);
                    }
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">CVtéque /</span> Gestion Des BUs
</h4>
                    ...
                    <div>
                        <ul class="list-group mb-4">
                            ...
                            <li class="list-group-item">
                                ...
                                <button type="button" onclick="editBu({{$bu->id}})" class="btn btn-primary btn-sm float-end me-2">Editer</button>
                            </li>
                            @endforeach
                        </ul>
                    </div>
