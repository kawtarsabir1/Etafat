...
<li><a href="{{ url('users/') }}"> {{__("users.update_role")}} </a></li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <input class="form-control form-control" name=name id="name" placeholder="Nom" value="{{$role->name}}">
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
...
$(function () { 
    ...
    @foreach($rolePermissions as $s)
        jQuery("#html1").jstree("select_node","#{{$s}}"); 
    @endforeach
...
$("form").bind('submit', function (e) {
        ...
        $.post("{{ route('roles.update', $role->id) }}",{ "_method": "PATCH",name:$("#name").val(),description:$("#description").val(),permissions:$("#html1").jstree("get_selected") },function(data){
            location.reload();
        }).fails(function(data){
            console.log(data);
        }) 
