    ...
    <div id="wizard-checkout" class="bs-stepper wizard-icons wizard-icons-example mt-2">
        <div class="bs-stepper-content">
            <form id="create-form" class="formInfos">
                <div>
                    <h5>Ajouter de Motif</h5>
                    <div class="col-12 row mb-4">
                        <div class="col-md-6">
                            <label class="form-label" for="Nom">Nom de Motif</label>
                    ...
                    <div>
                        <ul class="list-group mb-4">
                            ...
                            <li class="list-group-item">{{ $motif->motif }} <button type="button" onclick="deleteMotif({{$motif->id}})" class="btn btn-danger btn-sm float-end">Supprimer</button></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
