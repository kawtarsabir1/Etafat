    ...
    <div id="wizard-checkout" class="bs-stepper wizard-icons wizard-icons-example mt-2">
        <div class="bs-stepper-content">
            <form id="create-form" class="formInfos">
                <div>
                    <h5>Ajouter de Soustraitant</h5>
                    <div class="col-12 row mb-4">
                        <div class="col-md-6">
                            <label class="form-label" for="Nom">Nom de Soustraitant</label>
                            <input type="text" class="form-control" name="soustraitant" />
                        </div>
                        <div class="col-md-6">
                    ...
                    <div>
                        <ul class="list-group mb-4">
                            ...
                            <li class="list-group-item">{{ $soustraitant->soustraitant }} <button type="button" onclick="deleteSoustraitant({{$soustraitant->id}})" class="btn btn-danger btn-sm float-end">Supprimer</button></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
