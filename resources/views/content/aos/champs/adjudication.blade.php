...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                if ($.isEmptyObject(data.error)) {
                    alert('Adjudication ajouté avec succés.');
                    location.reload();
                } else {
    ...
    function deleteAdjudication(id) {
        if (confirm("Voulez-vous vraiment supprimer ce Adjudication ?")) {
            $.ajax({
                url: baseUrl + 'ao/champ/adjudication/' + id,
                type: 'DELETE',
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
                        alert('Adjudication supprimé avec succés.');
                        location.reload();
                    } else {
                        printErrorMsg(data.error);
                    }
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">CVtéque /</span> Gestion Des Adjudications
</h4>
